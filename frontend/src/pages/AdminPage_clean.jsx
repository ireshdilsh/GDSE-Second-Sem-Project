...
const AdminPage = () => {
  ...
  const recentSwaps = [
    { id: 1, from: 'Alice Johnson', to: 'Bob Smith', item: 'Vintage Guitar', status: 'Completed', date: '2024-01-15' },
    { id: 2, from: 'Carol Davis', to: 'David Wilson', item: 'Art Supplies', status: 'Pending', date: '2024-01-14' },
    { id: 3, from: 'Bob Smith', to: 'Alice Johnson', item: 'Books Collection', status: 'In Progress', date: '2024-01-13' }
  ];
